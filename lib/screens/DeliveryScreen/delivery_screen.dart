...
class _DeliveryScreenState extends State<DeliveryScreen> {
  ...
  getMainDeliveryDetails() async{
    try {
      setLoading(true);
      var response =await  OnlineDataBase.getDeliveryDetails(customercode: widget.shopDetails.customerCode,dataType: 'PSO',showFullDetails: false);
  ...
  getBoxDeliveryDetails() async{
    try {
      setLoading(true);
      var response = await OnlineDataBase.getBoxDeliveries(customercode: widget.shopDetails.customerCode,dataType: 'ORDERTRANSFER', );
      print("Response is: " + response.statusCode .toString());
      if (response.statusCode == 200) {
        var data = jsonDecode(utf8.decode(response.bodyBytes));
        // print("Response is: " + data.toString());
      ...
      print('exception getBoxDeliveryDetails: '+e.toString()+stack.toString());
      setLoading(false);
      Fluttertoast.showToast(
  ...
  getFullDeliveryDetails({String orderId})async{
    try {
      setLoading(true);
      var response =await  OnlineDataBase.getDeliveryDetails(customercode: widget.shopDetails.customerCode,dataType: 'PSOITEMS',showFullDetails: true,orderId: orderId);
      print("Response is" + response.statusCode .toString());
      if (response.statusCode == 200) {
        var data = jsonDecode(utf8.decode(response.bodyBytes));
        var datalist=data['results'];
        if(datalist!=null) {
          ...
          showDialog(fulldeliveryDetails: fulldeliveryDetails,orderId: orderId);
        ...
        child: Column(
            ...
            children: [
              ...
              widget.shopDetails.customerCode.toString(),
                  height: height,width: width,imageurl: "No Image"),
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              Container(
                                child: Column(
                                  ...
                                  children: [
                                    VariableText(
                                      text:'Box id: ${boxDelivery[index].trNumber}',
                                      fontsize:14,fontcolor: Colors.black,
                                      weight: FontWeight.w700,
                                    ),
                                    VariableText(
                                      text:'Sub Total : ${boxDelivery[index].totalAmount}',
                            ...
                            Container(
                              child: Expanded(
                                ...
                                child: InkWell(
                                  onTap:(){
                                    showBoxDialog(boxDetails: boxDelivery[index]);
                                  ...
                                  child: Container(height: height*0.04,
                                    ...
                                    child:    Row(
                                      ...
                                      children: [
                                        ...
                                        Image.asset('assets/icons/arrowright.png',scale: 2.5,)
                                      ],
                                    ),),
                                ),
                              ),
                            ...
                            Expanded(
                              ...
                              Container(
                                ...
                                child:    Column(
                                  ...
                                  children: [
                                    VariableText(
                                      text:'Order id: ${delivery[index].orderNumber}',
                                      fontsize:14,fontcolor: textcolorblack,
                                      weight: FontWeight.w700,
                                    ),
                                    VariableText(
                                      text:'Sub Total : ${delivery[index].subTotal}',
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Image.asset('assets/icons/ledger.png',color: Color(0xff1E1E1E), scale: 10.3),
                      SizedBox(width: height*0.01,),
                      VariableText(
                                              ...
                                              child: Center(
                                                child: TextField(
                                                  ...
                                                  decoration:InputDecoration(
                                                    hintText: boxDetails.orders[index].transferQty,
                                                    hintStyle: TextStyle(
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          VariableText(
                                            text: boxDetails.orders[index].product,
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height:height*0.0025,),
                                          VariableText(
                                            text: boxDetails.orders[index].amount,
                  ...
                  Row(
                    children: [
                      ...
                      VariableText(
                        //text:'Rs $subtotal',
                        text:'Rs ${f.format(double.parse(boxDetails.totalAmount.toString()))}',///////////
    ...
    AwesomeDialog(
      ...
      body:StatefulBuilder(builder: (context,setState){
        ...
        for(int i=0;i<fulldeliveryDetails.length;i++){
          subtotal+=fulldeliveryDetails[i].quantity*fulldeliveryDetails[i].rate;
        }
        return Container(
          height: height*0.55,
          width: width,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  Container(
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(5),
                                      border: Border.all(color: Color(0xffF6821F)),
                                      //color: Color(0xffF6821F).withOpacity(0.5),
                                    ),
                                    child: Row(
                                      children: [
                                          ...
                                          child: Container(
                                            ...
                                            child: Center(
                                              child: TextField(
                                                ...
                                                textAlign: TextAlign.center,
                                                textAlignVertical: TextAlignVertical.center,
                                                controller:fulldeliveryDetails[index].itemcountController,
                                                decoration:InputDecoration(
                                                  hintText: fulldeliveryDetails[index].quantity.toString(),
                                                  hintStyle: TextStyle(
                                                    fontSize:13,color: themeColor1,
                                                    fontWeight: FontWeight.w500,
                                                    ),
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        VariableText(
                                          text: fulldeliveryDetails[index].productName,
                                          fontsize:12,fontcolor: textcolorblack,
                                          weight: FontWeight.w500,
                                          textAlign: TextAlign.start,
                                        ),
                                        SizedBox(height:height*0.0025,),
                                        VariableText(
                                          text: fulldeliveryDetails[index].rate.toString(),
                                          fontsize:10,fontcolor: Color(0xff828282),
                                          weight: FontWeight.w400,
                                        ),
                                      ],
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height:height*0.0025,),
                                        VariableText(
                                          text:fulldeliveryDetails[index].itemtotal.toString(),
                                          fontsize:12,fontcolor: themeColor1,
                                          weight: FontWeight.w700,
  ...
  Widget customShopDetailsContainer(
   ...
   postOrderDetails({
    List<DeliveryModel> deliveryData,String orderNumber
  }) async{
    try {
      setState((){
        isLoading2=true;
      });
      var response =await  OnlineDataBase.postDeliverDetails(deliverydata:deliveryData,lat:widget.lat.toString(),long:widget.long.toString(),customerCode:widget.shopDetails.customerCode,orderNumber: orderNumber);
      print("Response is" + response.statusCode.toString());
      if (response.statusCode == 200) {
        var data = jsonDecode(utf8.decode(response.bodyBytes));
        print("Response is" + data.toString());
