...
import 'package:http/http.dart' as http;
  ...
  static Future<dynamic> getTranactionDetails({String customerCode}) async {
    var url =Uri.parse(directory+ 'getcustomers?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customerCode&pin_datatype=CRLB');
  ...
  static Future<dynamic> getDeliveryDetails({String customercode,String dataType,String orderId,bool showFullDetails}) async{
    var url=Uri.parse(
        showFullDetails? directory+ 'gettransactions?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customercode&pin_datatype=$dataType&pin_order_no=$orderId'
            : directory+ 'gettransactions?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customercode&pin_datatype=$dataType');
  ...
  static Future<dynamic> getBoxDeliveries({String customercode,String dataType}) async{
    var url=Uri.parse(directory+ 'getorders?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customercode&pin_datatype=$dataType');
    print("get delivery details url is: "+url.toString());
    final response=await http.get(url);
    return response;
  }
  ...
  static Future<dynamic> postDeliverDetails({List<DeliveryModel> deliverydata, String customerCode, String lat, String long,String orderNumber}) async {
    ...
    var url =Uri.parse(directory+ 'postdelivery?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customerCode&pin_longitude=$long&pin_latitude=$lat&pin_order_no=$orderNumber&file_type=json&file_name=');
  ...
  static Future<dynamic> postBoxDeliverDetails({BoxModel boxDetails, String customerCode, String lat, String long}) async {
    var url =Uri.parse(directory+ 'postboxdelivery?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customerCode&pin_longitude=$long&pin_latitude=$lat&pin_box_tr=${boxDetails.trNumber}');
  ...
  static Future<dynamic> postPayment({String customerCode, String imageUrl, String lat, String long, String paymentMode, String checkNumber, String amount, String name, String date}){
    String url=
    paymentMode=='1'?
    directory+'postcollection?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customerCode&pin_longitude=$long&pin_latitude=$lat&pin_pay_mode=$paymentMode&pin_cheq_date=&pin_amount=$amount&pin_rcvd_from=$name&file_type&file_name'
        :directory+'postcollection?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customerCode&pin_image_url=${imageUrl}&pin_longitude=$long&pin_latitude=$lat&pin_pay_mode=$paymentMode&pin_cheq=$checkNumber&pin_cheq_date=$date&pin_amount=$amount&pin_rcvd_from=$name&file_type&file_name';
  ...
  static Future<dynamic> postReturnOrder({RetrunCartModel cartData, String customerCode, String lat, String long}) async {
    var url =Uri.parse(directory+ 'postsalesreturn?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customerCode&pin_longitude=$long&pin_latitude=$lat&file_type=json&file_name=');
    ...
    for(var item in cartData.returncartItemName){
      postData['Orderitems']+=[ {"Prod_code":item.productName.productCode.toString(),
        "Qty": item.itemCount,
        "Rate": item.itemPrice,
    ...
    for(int i=0;i<cartData.returncartItemName.length;i++){
      bool isExist=false;
      print("data is"+cartData.returncartItemName[i].productName.productCode.toString());
      ...
      for(int k=0; k<templist.length; k++){
        if(templist[k].productName.productCode == cartData.returncartItemName[i].productName.productCode){
          isExist=true;
        }
      }
      if(!isExist){
        templist.add(cartData.returncartItemName[i]);
        temp['Orderitems']+=[ {"Prod_code":cartData.returncartItemName[i].productName.productCode.toString(),
          "Qty": totalCount,
  ...
  static Future<dynamic> getAllPrdouct() async {
    var url=Uri.parse(directory+'getprodprice?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=pin_cust_code');
  ...
  static Future<List<City>> getAllCities({Function task}) async{
    List<City> cities;
    var url = Uri.parse(directory+'getcities?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_city_code=');
  ...
  static Future<List<PartyCategories>> getPartyCategories() async{
    ...
    var url =Uri.parse(directory+'getpartycategories?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cat_code=');
  ...
  static Future<List<Area>> getAreaByCity(cityID) async{
    List<Area> areas;
    var url =Uri.parse(directory+'getcityareas?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_city_code=$cityID');
    print("get city url: "+url.toString());
    await  http.get(url).then((response) {
  ...
  static Future<dynamic> editShop({String customerCode,String imageUrl, String lat,String long,String address,String customerName,String customerName2,String customerPhoneNo,String CustomerPhoneNo2, String shopname,String partyCategory,String city,String area ,}){
    String url=directory+'posteditshop?pin_cmp=20&pin_kp=A&pin_keyword1=X09&pin_keyword2=912&pin_userid=$phoneNumber&pin_password=$phonepass&pin_cust_code=$customerCode&pin_shopname=${shopname}&pin_address=$address&pin_partycategory=$partyCategory&'
